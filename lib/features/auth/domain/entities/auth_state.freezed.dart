...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( Doctor doctor,  String accessToken,  String refreshToken)?  authenticated,TResult Function()?  unauthenticated,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case AuthStateInitial() when initial != null:
return initial();case AuthStateLoading() when loading != null:
return loading();case AuthStateAuthenticated() when authenticated != null:
return authenticated(_that.doctor,_that.accessToken,_that.refreshToken);case AuthStateUnauthenticated() when unauthenticated != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( Doctor doctor,  String accessToken,  String refreshToken)  authenticated,required TResult Function()  unauthenticated,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case AuthStateInitial():
return initial();case AuthStateLoading():
return loading();case AuthStateAuthenticated():
return authenticated(_that.doctor,_that.accessToken,_that.refreshToken);case AuthStateUnauthenticated():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( Doctor doctor,  String accessToken,  String refreshToken)?  authenticated,TResult? Function()?  unauthenticated,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case AuthStateInitial() when initial != null:
return initial();case AuthStateLoading() when loading != null:
return loading();case AuthStateAuthenticated() when authenticated != null:
...
class AuthStateAuthenticated implements AuthState {
  const AuthStateAuthenticated({required this.doctor, required this.accessToken, required this.refreshToken});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AuthStateAuthenticated&&(identical(other.doctor, doctor) || other.doctor == doctor)&&(identical(other.accessToken, accessToken) || other.accessToken == accessToken)&&(identical(other.refreshToken, refreshToken) || other.refreshToken == refreshToken));
}


@override
int get hashCode => Object.hash(runtimeType,doctor,accessToken,refreshToken);

@override
String toString() {
  return 'AuthState.authenticated(doctor: $doctor, accessToken: $accessToken, refreshToken: $refreshToken)';
}
...
@useResult
$Res call({
 Doctor doctor, String accessToken, String refreshToken
});
...
/// Create a copy of AuthState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? doctor = null,Object? accessToken = null,Object? refreshToken = null,}) {
  return _then(AuthStateAuthenticated(
doctor: null == doctor ? _self.doctor : doctor // ignore: cast_nullable_to_non_nullable
as Doctor,accessToken: null == accessToken ? _self.accessToken : accessToken // ignore: cast_nullable_to_non_nullable
